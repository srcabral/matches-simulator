package br.com.srcabral.matchessimulator.ui.adapter;
...
import br.com.srcabral.matchessimulator.databinding.MatchItemBinding;
import br.com.srcabral.matchessimulator.domain.Match;
import br.com.srcabral.matchessimulator.ui.DetailsActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Adapta os dados da partida (recuperada da API) para nos layout
        ...
        Glide.with(context).load(match.getAwayTeam().getImage()).circleCrop().into(holder.binding.ivVisitTeam);
